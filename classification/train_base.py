...
class MultiPartitioningClassifier(pl.LightningModule):
    ...
    def inference(self, batch):
        ...
        ## DEBUG
        ## print(f'hierarchy:{hierarchy_preds}')
    ...
    def test_step(self, batch, batch_idx, dataloader_idx=None):
        ...
        for i in range(nparts):
            ...
            ###
#             pred_lats_list.append(pred_lats)
#             pred_lngs_list.append(pred_lngs)
    ...
    def test_epoch_end(self, outputs):
        ...
        result=[]
        for item in outputs:
            result.append(item["hierarchy"].cpu().numpy())
#         print(outputs)
#         result = utils_global.summarize_test_gcd(
#             [p.shortname for p in self.partitionings], outputs[0], self.hierarchy
#         )
#         la=outputs[1]
#         lo=outputs[2]
        # print(result)
